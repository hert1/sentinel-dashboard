...
public class AuthorityRuleApiProvider implements DynamicRuleProvider<List<AuthorityRuleEntity>> {
    ...
    public List<AuthorityRuleEntity> getRules(String appName) throws Exception {
        ...
        String flowRule = configService.getConfig(appName, CommonConstant.AUTHORITY_GROUP, CommonConstant.TIME_OUT);
        if (StringUtil.isEmpty(flowRule)) {
            return new ArrayList<>();
        }
        return converter.convert(flowRule);
    }
}
